...
layui.define(['layer', 'notice'], function (exports) {
    ...
    var admin = {
         ...
         * @param failFn 失败的回调
         */
        handleMessage: function (response, successFn, failFn) {
    ...
    admin.events = {
        ...
        theme: function () {
            ...
            admin.strToWin($(this).data('window')).layui.admin.popupRight({
                id: 'layer-theme',
                type: 2,
                content: url ? url : '/assets/page/tpl/tpl-theme.html'
            });
        },
        /* 打开便签 */
        note: function () {
            ...
            admin.strToWin($(this).data('window')).layui.admin.popupRight({
                ...
                type: 2,
                closeBtn: false,
                content: url ? url : '/assets/page/tpl/tpl-note.html'
            });
        },
        /* 打开消息 */
        message: function () {
            ...
            admin.strToWin($(this).data('window')).layui.admin.popupRight({
                id: 'layer-notice',
                type: 2,
                content: url ? url : '/assets/page/tpl/tpl-message.html'
            });
        },
        /* 打开修改密码弹窗 */
        psw: function () {
            ...
            admin.strToWin($(this).data('window')).layui.admin.open({
                ...
                area: ['360px', '287px'],
                shade: 0,
                content: url ? url : '/assets/page/tpl/tpl-password.html'
            });
        },
        /* 退出登录 */
        logout: function () {
